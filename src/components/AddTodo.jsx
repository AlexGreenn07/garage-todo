...
export function AddTodo({ onAdd }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-6">
      <div className="dark:bg-page-dark flex items-center overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm focus-within:ring-2 focus-within:ring-blue-500 dark:border-2 dark:border-gray-500">
        <input
          type="text"
          value={text}
        ...
        <button
          ...
          className={`relative mx-2 flex h-10 w-10 items-center justify-center rounded-full transition-all duration-300 ${
            isListening
              ...
              : "bg-gray-100 text-gray-700 hover:bg-gray-300 dark:bg-gray-600 dark:text-gray-100 hover:dark:bg-gray-700"
          }`}
